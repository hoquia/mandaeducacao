...
import { TurmaService, RestTurma } from './turma.service';

const requireRestSample: RestTurma = {
  ...sampleWithRequiredData,
  abertura: sampleWithRequiredData.abertura?.format(DATE_FORMAT),
  encerramento: sampleWithRequiredData.encerramento?.format(DATE_FORMAT),
};
