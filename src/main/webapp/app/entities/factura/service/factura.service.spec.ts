...
const requireRestSample: RestFactura = {
  ...
  dataEmissao: sampleWithRequiredData.dataEmissao?.format(DATE_FORMAT),
  dataVencimento: sampleWithRequiredData.dataVencimento?.format(DATE_FORMAT),
  inicioTransporte: sampleWithRequiredData.inicioTransporte?.toJSON(),
  fimTransporte: sampleWithRequiredData.fimTransporte?.toJSON(),
