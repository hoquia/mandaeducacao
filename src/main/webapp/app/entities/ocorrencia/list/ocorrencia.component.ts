...
import { EntityArrayResponseType, OcorrenciaService } from '../service/ocorrencia.service';
...
export class OcorrenciaComponent implements OnInit {
  ...
  trackId = (_index: number, item: IOcorrencia): number => this.ocorrenciaService.getOcorrenciaIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.ocorrencias = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IOcorrencia[] | null): IOcorrencia[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.ocorrenciaService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
