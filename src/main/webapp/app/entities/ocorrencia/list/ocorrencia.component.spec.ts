...
describe('Ocorrencia Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ocorrencia', component: OcorrenciaComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ocorrencias?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to ocorrenciaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOcorrenciaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOcorrenciaIdentifier).toHaveBeenCalledWith(entity);
