...
import { EntityArrayResponseType, PlanoCurricularService } from '../service/plano-curricular.service';
...
export class PlanoCurricularComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPlanoCurricular): number => this.planoCurricularService.getPlanoCurricularIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.planoCurriculars = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPlanoCurricular[] | null): IPlanoCurricular[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.planoCurricularService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
