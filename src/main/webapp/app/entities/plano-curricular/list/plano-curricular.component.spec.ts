...
describe('PlanoCurricular Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'plano-curricular', component: PlanoCurricularComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.planoCurriculars?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to planoCurricularService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPlanoCurricularIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPlanoCurricularIdentifier).toHaveBeenCalledWith(entity);
