...
describe('Emolumento Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'emolumento', component: EmolumentoComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.emolumentos?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to emolumentoService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getEmolumentoIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getEmolumentoIdentifier).toHaveBeenCalledWith(entity);
