...
import { EntityArrayResponseType, EmolumentoService } from '../service/emolumento.service';
import { EmolumentoDeleteDialogComponent } from '../delete/emolumento-delete-dialog.component';
import { DataUtils } from 'app/core/util/data-util.service';
import { FilterOptions, IFilterOptions, IFilterOption } from 'app/shared/filter/filter.model';

@Component({
  selector: 'app-emolumento',
  templateUrl: './emolumento.component.html',
})
export class EmolumentoComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEmolumento): number => this.emolumentoService.getEmolumentoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.emolumentos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IEmolumento[] | null): IEmolumento[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.emolumentoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
