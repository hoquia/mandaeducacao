...
import { EntityArrayResponseType, DocumentoComercialService } from '../service/documento-comercial.service';
...
export class DocumentoComercialComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDocumentoComercial): number => this.documentoComercialService.getDocumentoComercialIdentifier(item);
  ...
  delete(documentoComercial: IDocumentoComercial): void {
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.documentoComercials = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IDocumentoComercial[] | null): IDocumentoComercial[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.documentoComercialService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
