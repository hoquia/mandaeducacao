...
describe('Docente Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'docente', component: DocenteComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to docenteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDocenteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDocenteIdentifier).toHaveBeenCalledWith(entity);
