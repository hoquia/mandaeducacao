...
@Component({
  selector: 'app-responsavel-area-formacao-detail',
  templateUrl: './responsavel-area-formacao-detail.component.html',
})
export class ResponsavelAreaFormacaoDetailComponent implements OnInit {
