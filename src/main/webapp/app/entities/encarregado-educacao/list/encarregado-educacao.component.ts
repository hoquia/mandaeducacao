...
import { EntityArrayResponseType, EncarregadoEducacaoService } from '../service/encarregado-educacao.service';
...
@Component({
  selector: 'app-encarregado-educacao',
  templateUrl: './encarregado-educacao.component.html',
})
export class EncarregadoEducacaoComponent implements OnInit {
  ...
  trackId = (_index: number, item: IEncarregadoEducacao): number => this.encarregadoEducacaoService.getEncarregadoEducacaoIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.encarregadoEducacaos = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IEncarregadoEducacao[] | null): IEncarregadoEducacao[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.encarregadoEducacaoService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
