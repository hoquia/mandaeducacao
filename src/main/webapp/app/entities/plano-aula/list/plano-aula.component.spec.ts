...
describe('PlanoAula Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'plano-aula', component: PlanoAulaComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.planoAulas?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to planoAulaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPlanoAulaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPlanoAulaIdentifier).toHaveBeenCalledWith(entity);
