...
import { EntityArrayResponseType, LookupItemService } from '../service/lookup-item.service';
...
export class LookupItemComponent implements OnInit {
  ...
  trackId = (_index: number, item: ILookupItem): number => this.lookupItemService.getLookupItemIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.lookupItems = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: ILookupItem[] | null): ILookupItem[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.lookupItemService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
