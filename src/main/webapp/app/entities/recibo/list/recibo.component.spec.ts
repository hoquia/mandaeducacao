...
describe('Recibo Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'recibo', component: ReciboComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to reciboService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getReciboIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getReciboIdentifier).toHaveBeenCalledWith(entity);
