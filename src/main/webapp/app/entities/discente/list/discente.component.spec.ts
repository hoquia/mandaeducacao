...
describe('Discente Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'discente', component: DiscenteComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to discenteService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDiscenteIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDiscenteIdentifier).toHaveBeenCalledWith(entity);
