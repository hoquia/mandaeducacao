...
import { EntityArrayResponseType, DiscenteService } from '../service/discente.service';
...
export class DiscenteComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDiscente): number => this.discenteService.getDiscenteIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.discentes = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IDiscente[] | null): IDiscente[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.discenteService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
