...
describe('MedidaDisciplinar Management Component', () => {
  let comp: MedidaDisciplinarComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'medida-disciplinar', component: MedidaDisciplinarComponent }]),
      ...
      .overrideTemplate(MedidaDisciplinarComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.medidaDisciplinars?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to medidaDisciplinarService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getMedidaDisciplinarIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getMedidaDisciplinarIdentifier).toHaveBeenCalledWith(entity);
