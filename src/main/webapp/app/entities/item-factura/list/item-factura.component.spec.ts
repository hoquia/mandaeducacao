...
describe('ItemFactura Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'item-factura', component: ItemFacturaComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to itemFacturaService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getItemFacturaIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getItemFacturaIdentifier).toHaveBeenCalledWith(entity);
