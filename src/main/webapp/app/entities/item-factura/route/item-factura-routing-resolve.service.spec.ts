...
describe('ItemFactura routing resolve service', () => {
  ...
  let resultItemFactura: IItemFactura | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultItemFactura).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IItemFactura>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
