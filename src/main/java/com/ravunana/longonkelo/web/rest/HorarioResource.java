...
import com.ravunana.longonkelo.service.HorarioQueryService;
...
/**
 * REST controller for managing {@link com.ravunana.longonkelo.domain.Horario}.
 */
@RestController
@RequestMapping("/api")
public class HorarioResource {
    ...
    public ResponseEntity<HorarioDTO> updateHorario(
        ...
        HorarioDTO result = horarioService.update(horarioDTO);
        return ResponseEntity
            .ok()
    ...
    public ResponseEntity<HorarioDTO> partialUpdateHorario(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody HorarioDTO horarioDTO
    ) throws URISyntaxException {
