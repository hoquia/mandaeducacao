...
import com.ravunana.longonkelo.service.FacturaQueryService;
...
/**
 * REST controller for managing {@link com.ravunana.longonkelo.domain.Factura}.
 */
@RestController
@RequestMapping("/api")
public class FacturaResource {
    ...
    public FacturaResource(
        ...
        this.reciboPagamentoEmolumentoService = reciboPagamentoEmolumentoService;
    }
    ...
    @GetMapping("/facturas/factura-geral/{facturaID}")
    public ResponseEntity<Resource> getReciboSalario(@PathVariable Long facturaID) throws IOException {
        var filePath = reciboPagamentoEmolumentoService.gerarReciboPdf(facturaID);
