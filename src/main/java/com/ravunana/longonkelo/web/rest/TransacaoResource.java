...
import com.ravunana.longonkelo.service.TransacaoQueryService;
...
/**
 * REST controller for managing {@link com.ravunana.longonkelo.domain.Transacao}.
 */
@RestController
@RequestMapping("/api")
public class TransacaoResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/transacaos/{id}", consumes = { "application/json", "application/merge-patch+json" })
