...
/**
 * Service Interface for managing {@link com.ravunana.longonkelo.domain.Horario}.
 */
public interface HorarioService {
     ...
     * Updates a horario.
     *
     * @param horarioDTO the entity to update.
     * @return the persisted entity.
     */
     ...
     * @return the list of entities.
     */
    Page<HorarioDTO> findAllWithEagerRelationships(Pageable pageable);
     ...
     */
    void delete(Long id);
    List<HorarioDTO> getHorarioDiscente(Long turmaID);
    List<HorarioDTO> getHorarioDocente(Long docenteID);
}
