...
/**
 * Criteria class for the {@link com.ravunana.longonkelo.domain.ResponsavelCurso} entity. This class is used
 * in {@link com.ravunana.longonkelo.web.rest.ResponsavelCursoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /responsavel-cursos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ResponsavelCursoCriteria implements Serializable, Criteria {
    ...
    public ResponsavelCursoCriteria() {}

    public ResponsavelCursoCriteria(ResponsavelCursoCriteria other) {
    ...
    @Override
    public ResponsavelCursoCriteria copy() {
        return new ResponsavelCursoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ResponsavelCursoCriteria that = (ResponsavelCursoCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, de, ate, timestamp, responsavelId, anoLectivoId, utilizadorId, cursoId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "ResponsavelCursoCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (de != null ? "de=" + de + ", " : "") +
            (ate != null ? "ate=" + ate + ", " : "") +
