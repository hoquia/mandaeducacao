...
/**
 * Criteria class for the {@link com.ravunana.longonkelo.domain.ResponsavelTurno} entity. This class is used
 * in {@link com.ravunana.longonkelo.web.rest.ResponsavelTurnoResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /responsavel-turnos?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ResponsavelTurnoCriteria implements Serializable, Criteria {
    ...
    public ResponsavelTurnoCriteria() {}

    public ResponsavelTurnoCriteria(ResponsavelTurnoCriteria other) {
    ...
    @Override
    public ResponsavelTurnoCriteria copy() {
        return new ResponsavelTurnoCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ResponsavelTurnoCriteria that = (ResponsavelTurnoCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, de, ate, timestamp, responsavelId, anoLectivoId, utilizadorId, turnoId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "ResponsavelTurnoCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (de != null ? "de=" + de + ", " : "") +
            (ate != null ? "ate=" + ate + ", " : "") +
