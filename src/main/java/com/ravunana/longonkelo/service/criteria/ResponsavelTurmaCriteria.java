...
/**
 * Criteria class for the {@link com.ravunana.longonkelo.domain.ResponsavelTurma} entity. This class is used
 * in {@link com.ravunana.longonkelo.web.rest.ResponsavelTurmaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /responsavel-turmas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ResponsavelTurmaCriteria implements Serializable, Criteria {
    ...
    public ResponsavelTurmaCriteria() {}

    public ResponsavelTurmaCriteria(ResponsavelTurmaCriteria other) {
    ...
    @Override
    public ResponsavelTurmaCriteria copy() {
        return new ResponsavelTurmaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final ResponsavelTurmaCriteria that = (ResponsavelTurmaCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, de, ate, timestamp, responsavelId, anoLectivoId, utilizadorId, turmaId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "ResponsavelTurmaCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (de != null ? "de=" + de + ", " : "") +
            (ate != null ? "ate=" + ate + ", " : "") +
