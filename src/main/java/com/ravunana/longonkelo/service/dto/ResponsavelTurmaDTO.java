...
/**
 * A DTO for the {@link com.ravunana.longonkelo.domain.ResponsavelTurma} entity.
 */
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ResponsavelTurmaDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ResponsavelTurmaDTO)) {
            return false;
        }

        ResponsavelTurmaDTO responsavelTurmaDTO = (ResponsavelTurmaDTO) o;
        if (this.id == null) {
            return false;
        }
        return Objects.equals(this.id, responsavelTurmaDTO.id);
    }
