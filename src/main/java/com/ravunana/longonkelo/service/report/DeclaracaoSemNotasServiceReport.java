...
@Service
public class DeclaracaoSemNotasServiceReport {
    ...
    public DeclaracaoSemNotasServiceReport(
    ...
    public String gerarDeclaracaoSemNotasPdf(Long matriculaID) {
        Document document;
        String pdfName;
        FileOutputStream file;
        pdfName = "declaracao sem notas";
        ...
        try {
            ...
            // Pdf Metadatas
            document.addTitle("Declaracao sem notas ");
            document.addSubject("declaracao sem notas");
            document.addKeywords("declaracao sem nota");
            ...
            layoutTable.addCell(
                makeCellTable(
                    getDeclaracaoSemNotas(matriculaID),
    ...
    private PdfPTable getDeclaracaoSemNotas(Long matriculaID) {
        ...
        Paragraph tituloDocumento = new Paragraph("DECLARACAO DE FREQUENCIA");
        ...
        layoutTable.addCell(
            makeCellTable(
                getAssinatura(SecurityUtils.getCurrentUserLogin().get(), "Nome Aqui"),
                Element.ALIGN_TOP,
                Element.ALIGN_CENTER,
                leading,
                padding,
