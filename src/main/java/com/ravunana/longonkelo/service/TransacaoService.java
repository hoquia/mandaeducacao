...
/**
 * Service Interface for managing {@link com.ravunana.longonkelo.domain.Transacao}.
 */
public interface TransacaoService {
     ...
     * @return the list of entities.
     */
    Page<TransacaoDTO> findAllWithEagerRelationships(Pageable pageable);
    ...
    void delete(Long id);
    //
    //    List<TransacaoDTO> getAllTrasacoes();
}
